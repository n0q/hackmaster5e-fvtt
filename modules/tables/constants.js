...
export const HMTABLES = {
    abilitymods: {
        ...
        wis: {
            0:  { init:  7, def: -4, mental: -4, fatigue:  3 },
            1:  { init:  6, def: -3, mental: -4, fatigue:  3 },
            2:  { init:  5, def: -3, mental: -3, fatigue:  2 },
            3:  { init:  4, def: -2, mental: -3, fatigue:  2 },
            4:  { init:  4, def: -2, mental: -2, fatigue:  2 },
            5:  { init:  4, def: -2, mental: -2, fatigue:  1 },
            6:  { init:  3, def: -1, mental: -1, fatigue:  1 },
            7:  { init:  3, def: -1, mental: -1, fatigue:  1 },
            8:  { init:  3, def: -1, mental:  0, fatigue:  0 },
            9:  { init:  2, def:  0, mental:  0, fatigue:  0 },
            10: { init:  2, def:  0, mental:  0, fatigue:  0 },
            11: { init:  1, def:  1, mental:  0, fatigue: -1 },
            12: { init:  1, def:  1, mental:  1, fatigue: -1 },
            13: { init:  1, def:  1, mental:  1, fatigue: -1 },
            14: { init:  0, def:  2, mental:  2, fatigue: -2 },
            15: { init:  0, def:  2, mental:  2, fatigue: -2 },
            16: { init:  0, def:  2, mental:  2, fatigue: -2 },
            17: { init: -1, def:  3, mental:  3, fatigue: -3 },
            18: { init: -1, def:  3, mental:  3, fatigue: -3 },
            19: { init: -1, def:  3, mental:  3, fatigue: -3 },
            20: { init: -1, def:  3, mental:  3, fatigue: -4 },
            21: { init: -1, def:  3, mental:  3, fatigue: -4 },
        },
        dex: {
        ...
        con: {
            0:  { physical: -5, fatigue:  5 },
            1:  { physical: -4, fatigue:  4 },
            2:  { physical: -3, fatigue:  4 },
            3:  { physical: -3, fatigue:  3 },
            4:  { physical: -2, fatigue:  3 },
            5:  { physical: -2, fatigue:  2 },
            6:  { physical: -1, fatigue:  2 },
            7:  { physical: -1, fatigue:  1 },
            8:  { physical:  0, fatigue:  1 },
            9:  { physical:  0, fatigue:  0 },
            10: { physical:  0, fatigue: -1 },
            11: { physical:  0, fatigue: -1 },
            12: { physical:  1, fatigue: -2 },
            13: { physical:  1, fatigue: -2 },
            14: { physical:  2, fatigue: -3 },
            15: { physical:  2, fatigue: -3 },
            16: { physical:  2, fatigue: -4 },
            17: { physical:  3, fatigue: -4 },
            18: { physical:  3, fatigue: -5 },
            19: { physical:  3, fatigue: -5 },
            20: { physical:  4, fatigue: -6 },
            21: { physical:  4, fatigue: -6 },
        },
        lks: {
            0:  { chamod: -6 },
            1:  { chamod: -5 },
